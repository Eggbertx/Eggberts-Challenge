...
function loadSprites() {
	...
	for(var i = 0, img_x = 0, img_y = 0; i < Object.keys(tiles_enum).length; i++ ) {
...
function loadData() {
	chips_dat_reader = new DataStream("CHIPS.DAT", FileOp.Read);
